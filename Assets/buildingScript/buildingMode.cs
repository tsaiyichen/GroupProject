...
public class buildingMode : MonoBehaviour
{
    ...
    void openIntroPanel(Building data)
    {
        ...
        ChangeButtonText(changeToFloor_intro, "加糷");
    ...
    {
        ChangeButtonText(changeToFloor_floor, "加糷");
    ...
    void floorButtonSetting(int currentPage, string buildingID)
    {
        ...
        for (int i = start; i < start + 5; i++)
        {
            ...
            else
            {
                ...
                if (current == 0)
                {
                    ChangeButtonText(floorBtns[i % floorBtns.Length], "");
                }
                else
                {
                    ChangeButtonText(floorBtns[i % floorBtns.Length], current + "加");
                }
